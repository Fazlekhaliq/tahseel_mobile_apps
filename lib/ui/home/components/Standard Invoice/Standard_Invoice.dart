...
class StandardInvoice extends StatefulWidget {
  const StandardInvoice({super.key});

  @override
  State<StandardInvoice> createState() => _StandardInvoiceState();
}

class _StandardInvoiceState extends State<StandardInvoice> {
  @override
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              SizedBox(height: 10,),
              CustomText(text: "Standard Invoice",
